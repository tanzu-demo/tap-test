...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=tanzu-demo&repo=tap-test",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->frontend]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=tanzu-demo&repo=tap-test'
